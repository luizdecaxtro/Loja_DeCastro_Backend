...
// Adicionamos a configuração para permitir requisições do seu frontend
app.use(cors({
    // Permite acesso de qualquer origem por enquanto (para testes)
    // Se for usar um domínio específico, mude para: origin: 'https://sua-loja.com.br'
    origin: '*', 
...
const storage = multer.diskStorage({
    destination: (req, file, cb) => {
        // Garantindo que a pasta uploads está no local correto
...
// ARQUIVOS ESTÁTICOS
// ADAPTAÇÃO CRÍTICA: REMOÇÃO do código que servia o Frontend.
...
app.get('/api/produtos', async (req, res) => {
    try {
        ...
        // Retorna um array vazio se o arquivo não existir (melhor UX)
...
app.post('/api/produtos', upload.single('imagem'), async (req, res) => {
    try {
        ...
        const novoProduto = {
            ...
            descricao: descricao,
            // O caminho salvo no JSON é ABSOLUTO: /uploads/nome-do-arquivo.jpg
